---
name: flashrag-methods-runner-skill
description: "Use when a user wants FlashRAG Named methods from FlashRAG examples, including naive, zero-shot, SKR, TRACE, reasoning, and refiner variants."
disable-model-invocation: true
---

# Named methods from FlashRAG examples, including naive, zero-shot, SKR, TRACE, reasoning, and refiner variants.

Use this sub-skill after the root `flash-rag` router selects `flashrag-methods-runner-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
...
- [scripts/make_method_config.py](scripts/make_method_config.py): bundled helper; run `python scripts/make_method_config.py --help` before use.
- [scripts/make_real_command.py](scripts/make_real_command.py): bundled helper; run `python scripts/make_real_command.py --help` before use.
- [scripts/preflight_method.py](scripts/preflight_method.py): bundled helper; run `python scripts/preflight_method.py --help` before use.
- [scripts/run_fake_method.py](scripts/run_fake_method.py): bundled helper; run `python scripts/run_fake_method.py --help` before use.
