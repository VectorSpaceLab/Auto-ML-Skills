...
def main() -> int:
    ...
    parser.add_argument("--pipeline", choices=["reasoning", "simple-deepsearcher", "searchr1", "autorefine", "o2searcher", "rearag", "corag"], default="reasoning")
    parser.add_argument("--sample-num", type=int, default=3)
    parser.add_argument("--retrieval-topk", type=int, default=2)
    parser.add_argument("--max-retrieval-num", type=int, default=2)
    ...
    cfg = {
        ...
        "save_note": f"reasoning-{args.pipeline}",
        "disable_save": False,
        "gpu_id": None,
        ...
        "use_fid": False,
        "refiner_name": None,
        "max_retrieval_num": args.max_retrieval_num,
