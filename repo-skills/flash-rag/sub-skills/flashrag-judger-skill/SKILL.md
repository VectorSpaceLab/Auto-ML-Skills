---
name: flashrag-judger-skill
description: "Use when a user wants FlashRAG SKR and adaptive judger data validation and fake route checks."
disable-model-invocation: true
---

# SKR and adaptive judger data validation and fake route checks.

Use this sub-skill after the root `flash-rag` router selects `flashrag-judger-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
...
- [scripts/make_judger_config.py](scripts/make_judger_config.py): bundled helper; run `python scripts/make_judger_config.py --help` before use.
- [scripts/make_skr_training.py](scripts/make_skr_training.py): bundled helper; run `python scripts/make_skr_training.py --help` before use.
- [scripts/run_fake_judger.py](scripts/run_fake_judger.py): bundled helper; run `python scripts/run_fake_judger.py --help` before use.
- [scripts/validate_judger_training.py](scripts/validate_judger_training.py): bundled helper; run `python scripts/validate_judger_training.py --help` before use.
