---
name: flashrag-kg-trace-refiner-skill
description: "Use when a user wants FlashRAG KG-Trace triple extraction and evidence-chain context smoke workflows."
disable-model-invocation: true
---

# KG-Trace triple extraction and evidence-chain context smoke workflows.

Use this sub-skill after the root `flash-rag` router selects `flashrag-kg-trace-refiner-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
...
- [scripts/make_trace_config.py](scripts/make_trace_config.py): bundled helper; run `python scripts/make_trace_config.py --help` before use.
- [scripts/make_trace_input.py](scripts/make_trace_input.py): bundled helper; run `python scripts/make_trace_input.py --help` before use.
- [scripts/run_fake_trace_refiner.py](scripts/run_fake_trace_refiner.py): bundled helper; run `python scripts/run_fake_trace_refiner.py --help` before use.
- [scripts/validate_trace_input.py](scripts/validate_trace_input.py): bundled helper; run `python scripts/validate_trace_input.py --help` before use.
