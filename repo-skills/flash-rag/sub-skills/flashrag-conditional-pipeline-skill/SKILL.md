---
name: flashrag-conditional-pipeline-skill
description: "Use when a user wants FlashRAG Conditional and adaptive pipeline routing by judger decisions."
disable-model-invocation: true
---

# Conditional and adaptive pipeline routing by judger decisions.

Use this sub-skill after the root `flash-rag` router selects `flashrag-conditional-pipeline-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
...
- [scripts/make_conditional_config.py](scripts/make_conditional_config.py): bundled helper; run `python scripts/make_conditional_config.py --help` before use.
- [scripts/run_fake_conditional_pipeline.py](scripts/run_fake_conditional_pipeline.py): bundled helper; run `python scripts/run_fake_conditional_pipeline.py --help` before use.
- [scripts/validate_conditional_data.py](scripts/validate_conditional_data.py): bundled helper; run `python scripts/validate_conditional_data.py --help` before use.
