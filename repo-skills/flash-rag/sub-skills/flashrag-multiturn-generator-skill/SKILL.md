---
name: flashrag-multiturn-generator-skill
description: "Use when a user wants FlashRAG Multi-turn generator prompt rendering and conversation smoke tests."
disable-model-invocation: true
---

# Multi-turn generator prompt rendering and conversation smoke tests.

Use this sub-skill after the root `flash-rag` router selects `flashrag-multiturn-generator-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
...
- [scripts/make_multiturn_config.py](scripts/make_multiturn_config.py): bundled helper; run `python scripts/make_multiturn_config.py --help` before use.
- [scripts/make_multiturn_messages.py](scripts/make_multiturn_messages.py): bundled helper; run `python scripts/make_multiturn_messages.py --help` before use.
- [scripts/run_fake_multiturn.py](scripts/run_fake_multiturn.py): bundled helper; run `python scripts/run_fake_multiturn.py --help` before use.
- [scripts/validate_messages.py](scripts/validate_messages.py): bundled helper; run `python scripts/validate_messages.py --help` before use.
