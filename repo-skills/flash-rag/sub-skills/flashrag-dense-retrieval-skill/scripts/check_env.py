#!/usr/bin/env python3
"""Check a public package environment for FlashRAG flashrag-dense-retrieval-skill.
...
REQUIRED = ['flashrag', 'datasets', 'yaml', 'numpy']
OPTIONAL = ['torch', 'transformers', 'tqdm', 'faiss', 'sentence_transformers']
DIST = {'yaml': 'PyYAML', 'PIL': 'Pillow', 'flashrag': 'flashrag-dev', 'faiss': 'faiss-cpu', 'Stemmer': 'PyStemmer'}
