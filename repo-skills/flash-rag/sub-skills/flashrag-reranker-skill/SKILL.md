---
name: flashrag-reranker-skill
description: "Use when a user wants FlashRAG Reranker configuration, offline rerank checks, and reranked-output inspection."
disable-model-invocation: true
---

# Reranker configuration, offline rerank checks, and reranked-output inspection.

Use this sub-skill after the root `flash-rag` router selects `flashrag-reranker-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
...
- [scripts/inspect_reranked.py](scripts/inspect_reranked.py): bundled helper; run `python scripts/inspect_reranked.py --help` before use.
- [scripts/make_rerank_config.py](scripts/make_rerank_config.py): bundled helper; run `python scripts/make_rerank_config.py --help` before use.
- [scripts/offline_rerank.py](scripts/offline_rerank.py): bundled helper; run `python scripts/offline_rerank.py --help` before use.
- [scripts/validate_retrieval_input.py](scripts/validate_retrieval_input.py): bundled helper; run `python scripts/validate_retrieval_input.py --help` before use.
