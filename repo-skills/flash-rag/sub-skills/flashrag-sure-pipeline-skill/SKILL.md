---
name: flashrag-sure-pipeline-skill
description: "Use when a user wants FlashRAG SuRe candidate, summary, validation, ranking, and final-answer pipeline smoke."
disable-model-invocation: true
---

# SuRe candidate, summary, validation, ranking, and final-answer pipeline smoke.

Use this sub-skill after the root `flash-rag` router selects `flashrag-sure-pipeline-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
...
- [scripts/make_sure_config.py](scripts/make_sure_config.py): bundled helper; run `python scripts/make_sure_config.py --help` before use.
...
- [scripts/run_fake_sure_pipeline.py](scripts/run_fake_sure_pipeline.py): bundled helper; run `python scripts/run_fake_sure_pipeline.py --help` before use.
- [scripts/validate_sure_data.py](scripts/validate_sure_data.py): bundled helper; run `python scripts/validate_sure_data.py --help` before use.
