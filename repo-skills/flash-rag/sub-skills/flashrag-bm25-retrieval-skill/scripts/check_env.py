#!/usr/bin/env python3
"""Check a public package environment for FlashRAG flashrag-bm25-retrieval-skill.
...
REQUIRED = ['flashrag', 'datasets', 'yaml', 'numpy', 'bm25s']
OPTIONAL = ['torch', 'transformers', 'tqdm', 'faiss', 'langid', 'Stemmer']
