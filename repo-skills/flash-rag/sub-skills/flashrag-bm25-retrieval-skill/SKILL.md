---
name: flashrag-bm25-retrieval-skill
description: "Use when a user wants FlashRAG BM25s lexical index building and search without dense models."
disable-model-invocation: true
---

# BM25s lexical index building and search without dense models.

Use this sub-skill after the root `flash-rag` router selects `flashrag-bm25-retrieval-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
...
- [scripts/build_bm25_index.py](scripts/build_bm25_index.py): bundled helper; run `python scripts/build_bm25_index.py --help` before use.
- [scripts/check_env.py](scripts/check_env.py): bundled helper; run `python scripts/check_env.py --help` before use.
- [scripts/flashrag_import_stubs.py](scripts/flashrag_import_stubs.py): support module imported by nearby scripts; read or adapt it only when modifying helper behavior.
- [scripts/inspect_output.py](scripts/inspect_output.py): bundled helper; run `python scripts/inspect_output.py --help` before use.
- [scripts/make_bm25_config.py](scripts/make_bm25_config.py): bundled helper; run `python scripts/make_bm25_config.py --help` before use.
- [scripts/run_bm25_search.py](scripts/run_bm25_search.py): bundled helper; run `python scripts/run_bm25_search.py --help` before use.
