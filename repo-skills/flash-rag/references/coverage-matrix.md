...
| Benchmark reproduction setup, method-specific extra models, unified E5/Llama3 settings, and result-alignment checks. | `sub-skills/flashrag-benchmark-reproduction-skill` | covers public reproduction prerequisites, method dependency matrix, config patch generation, and result inspection without original example files |
