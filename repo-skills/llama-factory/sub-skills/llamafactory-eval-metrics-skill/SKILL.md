---
name: llamafactory-eval-metrics-skill
description: "Use when a user wants LLaMA-Factory BLEU, ROUGE, perplexity, learning-rate, and score inspection utilities."
disable-model-invocation: true
---

# BLEU, ROUGE, perplexity, learning-rate, and score inspection utilities.

Use this sub-skill after the root `llama-factory` router selects `llamafactory-eval-metrics-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
...
- [scripts/inspect_scores.py](scripts/inspect_scores.py): bundled helper; run `python scripts/inspect_scores.py --help` before use.
- [scripts/run_bleu_rouge.py](scripts/run_bleu_rouge.py): bundled helper; run `python scripts/run_bleu_rouge.py --help` before use.
- [scripts/run_lr.py](scripts/run_lr.py): bundled helper; run `python scripts/run_lr.py --help` before use.
- [scripts/run_ppl.py](scripts/run_ppl.py): bundled helper; run `python scripts/run_ppl.py --help` before use.
- [scripts/validate_predictions.py](scripts/validate_predictions.py): bundled helper; run `python scripts/validate_predictions.py --help` before use.
