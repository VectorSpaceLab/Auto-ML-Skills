...
from lf_skill_common import env_for
...
def main() -> int:
    ...
    proc = subprocess.Popen([args.python, "-m", "llamafactory.cli", "webui"], cwd=str(args.work_dir), env=env, stdout=handle, stderr=subprocess.STDOUT)
