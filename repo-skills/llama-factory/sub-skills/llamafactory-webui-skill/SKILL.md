---
name: llamafactory-webui-skill
description: "Use when a user wants LLaMA-Factory WebUI / LlamaBoard launch and health checks."
disable-model-invocation: true
---

# LLaMA-Factory WebUI / LlamaBoard launch and health checks.

Use this sub-skill after the root `llama-factory` router selects `llamafactory-webui-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
