---
name: llamafactory-rm-skill
description: "Use when a user wants LLaMA-Factory Reward model training and pairwise preference scoring."
disable-model-invocation: true
---

# Reward model training and pairwise preference scoring.

Use this sub-skill after the root `llama-factory` router selects `llamafactory-rm-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
...
- [scripts/make_v1_pair_dataset.py](scripts/make_v1_pair_dataset.py): bundled helper; run `python scripts/make_v1_pair_dataset.py --help` before use.
- [scripts/make_v1_rm_config.py](scripts/make_v1_rm_config.py): bundled helper; run `python scripts/make_v1_rm_config.py --help` before use.
- [scripts/run_v1_rm.py](scripts/run_v1_rm.py): bundled helper; run `python scripts/run_v1_rm.py --help` before use.
- [scripts/validate_rm_data.py](scripts/validate_rm_data.py): bundled helper; run `python scripts/validate_rm_data.py --help` before use.
