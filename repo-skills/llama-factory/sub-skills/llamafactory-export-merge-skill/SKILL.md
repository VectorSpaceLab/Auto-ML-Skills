---
name: llamafactory-export-merge-skill
description: "Use when a user wants LLaMA-Factory LoRA adapter export, merge, Modelfile generation, and exported artifact inspection."
disable-model-invocation: true
---

# LoRA adapter export, merge, Modelfile generation, and exported artifact inspection.

Use this sub-skill after the root `llama-factory` router selects `llamafactory-export-merge-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
...
- [scripts/inspect_export.py](scripts/inspect_export.py): bundled helper; run `python scripts/inspect_export.py --help` before use.
- [scripts/make_export_config.py](scripts/make_export_config.py): bundled helper; run `python scripts/make_export_config.py --help` before use.
- [scripts/run_export.py](scripts/run_export.py): bundled helper; run `python scripts/run_export.py --help` before use.
- [scripts/validate_adapter.py](scripts/validate_adapter.py): bundled helper; run `python scripts/validate_adapter.py --help` before use.
