---
name: llamafactory-openai-api-skill
description: "Use when a user wants LLaMA-Factory OpenAI-compatible API server launch, health check, and shutdown."
disable-model-invocation: true
---

# OpenAI-compatible API server launch, health check, and shutdown.

Use this sub-skill after the root `llama-factory` router selects `llamafactory-openai-api-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
...
- [scripts/check_api.py](scripts/check_api.py): bundled helper; run `python scripts/check_api.py --help` before use.
...
- [scripts/make_api_config.py](scripts/make_api_config.py): bundled helper; run `python scripts/make_api_config.py --help` before use.
- [scripts/run_api_server.py](scripts/run_api_server.py): bundled helper; run `python scripts/run_api_server.py --help` before use.
- [scripts/stop_api_server.py](scripts/stop_api_server.py): bundled helper; run `python scripts/stop_api_server.py --help` before use.
