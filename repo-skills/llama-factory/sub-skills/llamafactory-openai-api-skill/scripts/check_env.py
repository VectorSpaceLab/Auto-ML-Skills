#!/usr/bin/env python3
"""Check a public package environment for LLaMA-Factory llamafactory-openai-api-skill.
...
REQUIRED = ['llamafactory', 'torch', 'transformers', 'datasets', 'yaml', 'fastapi', 'uvicorn']
OPTIONAL = ['accelerate', 'peft', 'trl', 'sse_starlette']
