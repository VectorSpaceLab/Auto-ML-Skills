...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate a default/v0 LLaMA-Factory KTO config.")
    parser.add_argument("--output", type=Path, required=True)
    parser.add_argument("--model", required=True)
    parser.add_argument("--dataset", default="kto_en_demo")
    ...
    parser.add_argument("--kto-chosen-weight", type=float, default=1.0)
    parser.add_argument("--kto-rejected-weight", type=float, default=1.0)
    ...
    cfg = {
        ...
        "kto_chosen_weight": args.kto_chosen_weight,
        "kto_rejected_weight": args.kto_rejected_weight,
