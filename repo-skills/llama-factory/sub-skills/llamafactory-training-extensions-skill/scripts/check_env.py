#!/usr/bin/env python3
"""Check a public package environment for LLaMA-Factory llamafactory-training-extensions-skill.
...
OPTIONAL = ['accelerate', 'peft', 'trl', 'galore_torch', 'apollo_torch', 'badam']
