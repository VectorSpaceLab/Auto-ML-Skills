---
name: llamafactory-benchmark-stats-skill
description: "Use when a user wants LLaMA-Factory FLOPs, MFU, length CDF, Qwen benchmark, and training-stat utilities."
disable-model-invocation: true
---

# FLOPs, MFU, length CDF, Qwen benchmark, and training-stat utilities.

Use this sub-skill after the root `llama-factory` router selects `llamafactory-benchmark-stats-skill`. It is focused on one workflow family and should be enough to validate inputs, generate/adapt configs, run a smoke test, inspect outputs, and then scale to the user's requested run without reopening the original repository docs.
...
- [scripts/estimate_mfu.py](scripts/estimate_mfu.py): bundled helper; run `python scripts/estimate_mfu.py --help` before use.
- [scripts/make_stat_command.py](scripts/make_stat_command.py): bundled helper; run `python scripts/make_stat_command.py --help` before use.
- [scripts/preflight_stat.py](scripts/preflight_stat.py): bundled helper; run `python scripts/preflight_stat.py --help` before use.
- [scripts/run_stat.py](scripts/run_stat.py): bundled helper; run `python scripts/run_stat.py --help` before use.
