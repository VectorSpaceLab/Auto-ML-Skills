...
description: "Load DeePMD-kit models, run Python or CLI inference, extract descriptors and embeddings, compute model deviation, and operate on frozen/checkpoint/pretrained model artifacts."
