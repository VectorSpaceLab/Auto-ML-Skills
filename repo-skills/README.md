...
- `slime/`: slime skill router plus sub-skills for RL/SFT training, SGLang rollout serving, checkpoint conversion, model recipes, async rollout, custom rollout hooks, profiling, reproducibility, and deployment utilities.
