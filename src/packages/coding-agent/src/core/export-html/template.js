    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="disco-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="disco-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'disco-share:v1:sidebar-width';
