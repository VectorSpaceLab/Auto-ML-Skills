...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@auto-ml-skills/disco` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@auto-ml-skills/disco";
	 *
...
export interface ExtensionContext {
	...
	/** Execute another registered tool through the current extension runtime. */
	executeTool(
		name: string,
		params: unknown,
		options?: {
