...
const MIGRATION_GUIDE_URL = "README.md";
const EXTENSIONS_DOC_URL = "README.md";
...
/**
 * Migrate legacy sessions from the agent root into proper session directories.
 *
 * Older sessions were saved to the agent root instead of
 * <agent-dir>/sessions/<encoded-cwd>/. This migration moves them
 ...
 * Note: tools/ may contain fd/rg binaries extracted by DisCo, so only warn if it has other files.
 */
