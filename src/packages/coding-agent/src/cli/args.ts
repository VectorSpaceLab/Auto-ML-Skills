...
${chalk.bold("Examples:")}
  ...
  ${APP_NAME} "Prepare an inspection env for /path/to/repo" "Then create the repo skill"
  ...
  # Use different model
  ${APP_NAME} --provider openai --model gpt-4o-mini "Create a skill for this repo"

  # Use model with provider prefix (no --provider needed)
  ${APP_NAME} --model openai/gpt-4o "Create a skill for this repo"
