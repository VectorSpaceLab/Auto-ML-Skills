/**
 * User-level settings for DisCo dynamic workflows.
 *
 * Stored separately from DisCo's own settings.json so extension preferences remain
...
/** Path to the user-level workflow settings JSON file (~/.disco/workflows/settings.json). */
