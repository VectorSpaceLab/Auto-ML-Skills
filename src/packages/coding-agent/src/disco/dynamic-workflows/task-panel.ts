...
import { type Component, type TUI, truncateToWidth, visibleWidth } from "@auto-ml-skills/disco-tui";
import { shorten, statusIcon, type WorkflowAgentSnapshot, type WorkflowSnapshot } from "./display.ts";
