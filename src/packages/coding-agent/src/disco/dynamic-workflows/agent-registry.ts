 ...
 *
 * Definitions live as Markdown files under `.disco/agents/*.md` (project,
 * cwd-relative) and `~/.disco/agents/*.md` (user). Frontmatter binds the
 * subagent's tools, model, and a body prompt; project definitions win on a
 * name collision. This mirrors
